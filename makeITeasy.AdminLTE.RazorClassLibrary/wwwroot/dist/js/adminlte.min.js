 ...
 */
(function(n,t){typeof exports=="object"&&typeof module!="undefined"?t(exports,require("jquery")):typeof define=="function"&&define.amd?define(["exports","jquery"],t):(n=typeof globalThis!="undefined"?globalThis:n||self,t(n.adminlte={},n.jQuery))})(this,function(n,t){"use strict";function ae(n){return n&&typeof n=="object"&&"default"in n?n:{"default":n}}var i=ae(t),b="CardRefresh",wi="lte.cardrefresh",bi="."+wi,ve=i["default"].fn[b],ye="loaded"+bi,pe="overlay.added"+bi,we="overlay.removed"+bi,nu="card",be="."+nu,ki='[data-card-widget="card-refresh"]',tu={source:"",sourceSelector:"",params:{},trigger:ki,content:".card-body",loadInContent:!0,loadOnInit:!0,responseType:"",overlayTemplate:'<div class="overlay"><i class="fas fa-2x fa-sync-alt fa-spin"><\/i><\/div>',onLoadStart:function(){},onLoadDone:function(n){return n}},h=function(){function n(n,t){if(this._element=n,this._parent=n.parents(be).first(),this._settings=i["default"].extend({},tu,t),this._overlay=i["default"](this._settings.overlayTemplate),n.hasClass(nu)&&(this._parent=n),this._settings.source==="")throw new Error("Source url was not defined. Please specify a url in your CardRefresh source option.");}var t=n.prototype;return t.load=function(){var n=this;this._addOverlay();this._settings.onLoadStart.call(i["default"](this));i["default"].get(this._settings.source,this._settings.params,function(t){n._settings.loadInContent&&(n._settings.sourceSelector!==""&&(t=i["default"](t).find(n._settings.sourceSelector).html()),n._parent.find(n._settings.content).html(t));n._settings.onLoadDone.call(i["default"](n),t);n._removeOverlay()},this._settings.responseType!==""&&this._settings.responseType);i["default"](this._element).trigger(i["default"].Event(ye))},t._addOverlay=function(){this._parent.append(this._overlay);i["default"](this._element).trigger(i["default"].Event(pe))},t._removeOverlay=function(){this._parent.find(this._overlay).remove();i["default"](this._element).trigger(i["default"].Event(we))},t._init=function(){var n=this;i["default"](this).find(this._settings.trigger).on("click",function(){n.load()});this._settings.loadOnInit&&this.load()},n._jQueryInterface=function(t){var r=i["default"](this).data(wi),u=i["default"].extend({},tu,i["default"](this).data());r||(r=new n(i["default"](this),u),i["default"](this).data(wi,typeof t=="string"?r:t));typeof t=="string"&&t.match(/load/)?r[t]():r._init(i["default"](this))},n}();i["default"](document).on("click",ki,function(n){n&&n.preventDefault();h._jQueryInterface.call(i["default"](this),"load")});i["default"](function(){i["default"](ki).each(function(){h._jQueryInterface.call(i["default"](this))})});i["default"].fn[b]=h._jQueryInterface;i["default"].fn[b].Constructor=h;i["default"].fn[b].noConflict=function(){return i["default"].fn[b]=ve,h._jQueryInterface};var k="CardWidget",di="lte.cardwidget",d="."+di,ke=i["default"].fn[k],de="expanded"+d,ge="collapsed"+d,no="maximized"+d,to="minimized"+d,io="removed"+d,iu="card",ii="collapsed-card",ru="collapsing-card",uu="expanding-card",gi="was-collapsed",g="maximized-card",fu='[data-card-widget="remove"]',eu='[data-card-widget="collapse"]',ou='[data-card-widget="maximize"]',ro="."+iu,su=".card-header",hu=".card-body",cu=".card-footer",lu={animationSpeed:"normal",collapseTrigger:eu,removeTrigger:fu,maximizeTrigger:ou,collapseIcon:"fa-minus",expandIcon:"fa-plus",maximizeIcon:"fa-expand",minimizeIcon:"fa-compress"},f=function(){function t(n,t){this._element=n;this._parent=n.parents(ro).first();n.hasClass(iu)&&(this._parent=n);this._settings=i["default"].extend({},lu,t)}var n=t.prototype;return n.collapse=function(){var n=this;this._parent.addClass(ru).children(hu+", "+cu).slideUp(this._settings.animationSpeed,function(){n._parent.addClass(ii).removeClass(ru)});this._parent.find("> "+su+" "+this._settings.collapseTrigger+" ."+this._settings.collapseIcon).addClass(this._settings.expandIcon).removeClass(this._settings.collapseIcon);this._element.trigger(i["default"].Event(ge),this._parent)},n.expand=function(){var n=this;this._parent.addClass(uu).children(hu+", "+cu).slideDown(this._settings.animationSpeed,function(){n._parent.removeClass(ii).removeClass(uu)});this._parent.find("> "+su+" "+this._settings.collapseTrigger+" ."+this._settings.expandIcon).addClass(this._settings.collapseIcon).removeClass(this._settings.expandIcon);this._element.trigger(i["default"].Event(de),this._parent)},n.remove=function(){this._parent.slideUp();this._element.trigger(i["default"].Event(io),this._parent)},n.toggle=function(){if(this._parent.hasClass(ii)){this.expand();return}this.collapse()},n.maximize=function(){this._parent.find(this._settings.maximizeTrigger+" ."+this._settings.maximizeIcon).addClass(this._settings.minimizeIcon).removeClass(this._settings.maximizeIcon);this._parent.css({height:this._parent.height(),width:this._parent.width(),transition:"all .15s"}).delay(150).queue(function(){var n=i["default"](this);n.addClass(g);i["default"]("html").addClass(g);n.hasClass(ii)&&n.addClass(gi);n.dequeue()});this._element.trigger(i["default"].Event(no),this._parent)},n.minimize=function(){this._parent.find(this._settings.maximizeTrigger+" ."+this._settings.minimizeIcon).addClass(this._settings.maximizeIcon).removeClass(this._settings.minimizeIcon);this._parent.css("cssText","height: "+this._parent[0].style.height+" !important; width: "+this._parent[0].style.width+" !important; transition: all .15s;").delay(10).queue(function(){var n=i["default"](this);n.removeClass(g);i["default"]("html").removeClass(g);n.css({height:"inherit",width:"inherit"});n.hasClass(gi)&&n.removeClass(gi);n.dequeue()});this._element.trigger(i["default"].Event(to),this._parent)},n.toggleMaximize=function(){if(this._parent.hasClass(g)){this.minimize();return}this.maximize()},n._init=function(n){var t=this;this._parent=n;i["default"](this).find(this._settings.collapseTrigger).click(function(){t.toggle()});i["default"](this).find(this._settings.maximizeTrigger).click(function(){t.toggleMaximize()});i["default"](this).find(this._settings.removeTrigger).click(function(){t.remove()})},t._jQueryInterface=function(n){var r=i["default"](this).data(di),u=i["default"].extend({},lu,i["default"](this).data());r||(r=new t(i["default"](this),u),i["default"](this).data(di,typeof n=="string"?r:n));typeof n=="string"&&n.match(/collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/)?r[n]():typeof n=="object"&&r._init(i["default"](this))},t}();i["default"](document).on("click",eu,function(n){n&&n.preventDefault();f._jQueryInterface.call(i["default"](this),"toggle")});i["default"](document).on("click",fu,function(n){n&&n.preventDefault();f._jQueryInterface.call(i["default"](this),"remove")});i["default"](document).on("click",ou,function(n){n&&n.preventDefault();f._jQueryInterface.call(i["default"](this),"toggleMaximize")});i["default"].fn[k]=f._jQueryInterface;i["default"].fn[k].Constructor=f;i["default"].fn[k].noConflict=function(){return i["default"].fn[k]=ke,f._jQueryInterface};var nt="ControlSidebar",nr="lte.controlsidebar",au="."+nr,uo=i["default"].fn[nt],fo="collapsed"+au,eo="expanded"+au,c=".control-sidebar",vu=".control-sidebar-content",tr=".main-header",ri=".main-footer",ui="control-sidebar-animate",fi="control-sidebar-open",ei="control-sidebar-slide-open",yu="layout-fixed",oo="layout-navbar-fixed",so="layout-sm-navbar-fixed",ho="layout-md-navbar-fixed",co="layout-lg-navbar-fixed",lo="layout-xl-navbar-fixed",pu="layout-footer-fixed",wu="layout-sm-footer-fixed",bu="layout-md-footer-fixed",ku="layout-lg-footer-fixed",du="layout-xl-footer-fixed",ao={controlsidebarSlide:!0,scrollbarTheme:"os-theme-light",scrollbarAutoHide:"l"},tt=function(){function t(n,t){this._element=n;this._config=t;this._init()}var n=t.prototype;return n.collapse=function(){var n=i["default"]("body"),t=i["default"]("html");this._config.controlsidebarSlide?(t.addClass(ui),n.removeClass(ei).delay(300).queue(function(){i["default"](c).hide();t.removeClass(ui);i["default"](this).dequeue()})):n.removeClass(fi);i["default"](this._element).trigger(i["default"].Event(fo))},n.show=function(){var n=i["default"]("body"),t=i["default"]("html");this._config.controlsidebarSlide?(t.addClass(ui),i["default"](c).show().delay(10).queue(function(){n.addClass(ei).delay(300).queue(function(){t.removeClass(ui);i["default"](this).dequeue()});i["default"](this).dequeue()})):n.addClass(fi);this._fixHeight();this._fixScrollHeight();i["default"](this._element).trigger(i["default"].Event(eo))},n.toggle=function(){var n=i["default"]("body"),t=n.hasClass(fi)||n.hasClass(ei);t?this.collapse():this.show()},n._init=function(){var n=this;this._fixHeight();this._fixScrollHeight();i["default"](window).resize(function(){n._fixHeight();n._fixScrollHeight()});i["default"](window).scroll(function(){var t=i["default"]("body"),r=t.hasClass(fi)||t.hasClass(ei);r&&n._fixScrollHeight()})},n._fixScrollHeight=function(){var t=i["default"]("body"),e;if(t.hasClass(yu)){var n={scroll:i["default"](document).height(),window:i["default"](window).height(),header:i["default"](tr).outerHeight(),footer:i["default"](ri).outerHeight()},r={bottom:Math.abs(n.window+i["default"](window).scrollTop()-n.scroll),top:i["default"](window).scrollTop()},o=(t.hasClass(oo)||t.hasClass(so)||t.hasClass(ho)||t.hasClass(co)||t.hasClass(lo))&&i["default"](tr).css("position")==="fixed",s=(t.hasClass(pu)||t.hasClass(wu)||t.hasClass(bu)||t.hasClass(ku)||t.hasClass(du))&&i["default"](ri).css("position")==="fixed",u=i["default"](c),f=i["default"](c+", "+c+" "+vu);r.top===0&&r.bottom===0?(u.css({bottom:n.footer,top:n.header}),f.css("height",n.window-(n.header+n.footer))):r.bottom<=n.footer?s===!1?(e=n.header-r.top,u.css("bottom",n.footer-r.bottom).css("top",e>=0?e:0),f.css("height",n.window-(n.footer-r.bottom))):u.css("bottom",n.footer):r.top<=n.header?o===!1?(u.css("top",n.header-r.top),f.css("height",n.window-(n.header-r.top))):u.css("top",n.header):o===!1?(u.css("top",0),f.css("height",n.window)):u.css("top",n.header)}},n._fixHeight=function(){var n=i["default"]("body"),t,r,u;n.hasClass(yu)&&(t={window:i["default"](window).height(),header:i["default"](tr).outerHeight(),footer:i["default"](ri).outerHeight()},r=t.window-t.header,(n.hasClass(pu)||n.hasClass(wu)||n.hasClass(bu)||n.hasClass(ku)||n.hasClass(du))&&i["default"](ri).css("position")==="fixed"&&(r=t.window-t.header-t.footer),u=i["default"](c+" "+vu),u.css("height",r),typeof i["default"].fn.overlayScrollbars!="undefined"&&u.overlayScrollbars({className:this._config.scrollbarTheme,sizeAutoCapable:!0,scrollbars:{autoHide:this._config.scrollbarAutoHide,clickScrolling:!0}}))},t._jQueryInterface=function(n){return this.each(function(){var r=i["default"](this).data(nr),u=i["default"].extend({},ao,i["default"](this).data());if(r||(r=new t(this,u),i["default"](this).data(nr,r)),r[n]==="undefined")throw new Error(n+" is not a function");r[n]()})},t}();i["default"](document).on("click",'[data-widget="control-sidebar"]',function(n){n.preventDefault();tt._jQueryInterface.call(i["default"](this),"toggle")});i["default"].fn[nt]=tt._jQueryInterface;i["default"].fn[nt].Constructor=tt;i["default"].fn[nt].noConflict=function(){return i["default"].fn[nt]=uo,tt._jQueryInterface};var it="DirectChat",ir="lte.directchat",vo="."+ir,yo=i["default"].fn[it],po="toggled"+vo,wo=".direct-chat",bo="direct-chat-contacts-open",rt=function(){function n(n){this._element=n}var t=n.prototype;return t.toggle=function(){i["default"](this._element).parents(wo).first().toggleClass(bo);i["default"](this._element).trigger(i["default"].Event(po))},n._jQueryInterface=function(t){return this.each(function(){var r=i["default"](this).data(ir);r||(r=new n(i["default"](this)),i["default"](this).data(ir,r));r[t]()})},n}();i["default"](document).on("click",'[data-widget="chat-pane-toggle"]',function(n){n&&n.preventDefault();rt._jQueryInterface.call(i["default"](this),"toggle")});i["default"].fn[it]=rt._jQueryInterface;i["default"].fn[it].Constructor=rt;i["default"].fn[it].noConflict=function(){return i["default"].fn[it]=yo,rt._jQueryInterface};var ut="Dropdown",gu="lte.dropdown",ko=i["default"].fn[ut],nf=".dropdown-menu",go=".dropdown-menu.show",tf='[data-toggle="dropdown"]',ns="dropdown-menu-right",ts="dropdown-submenu",is={},l=function(){function n(n,t){this._config=t;this._element=n}var t=n.prototype;return t.toggleSubmenu=function(){this._element.siblings().show().toggleClass("show");this._element.next().hasClass("show")||this._element.parents(nf).first().find(".show").removeClass("show").hide();this._element.parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown",function(){i["default"](".dropdown-submenu .show").removeClass("show").hide()})},t.fixPosition=function(){var n=i["default"](go);if(n.length!==0){n.hasClass(ns)?n.css({left:"inherit",right:0}):n.css({left:0,right:"inherit"});var t=n.offset(),r=n.width(),u=i["default"](window).width()-t.left;t.left<0?n.css({left:"inherit",right:t.left-5}):u<r&&n.css({left:"inherit",right:0})}},n._jQueryInterface=function(t){return this.each(function(){var r=i["default"](this).data(gu),u=i["default"].extend({},is,i["default"](this).data());r||(r=new n(i["default"](this),u),i["default"](this).data(gu,r));(t==="toggleSubmenu"||t==="fixPosition")&&r[t]()})},n}();i["default"](nf+" "+tf).on("click",function(n){n.preventDefault();n.stopPropagation();l._jQueryInterface.call(i["default"](this),"toggleSubmenu")});i["default"](".navbar "+tf).on("click",function(n){(n.preventDefault(),i["default"](n.target).parent().hasClass(ts))||setTimeout(function(){l._jQueryInterface.call(i["default"](this),"fixPosition")},1)});i["default"].fn[ut]=l._jQueryInterface;i["default"].fn[ut].Constructor=l;i["default"].fn[ut].noConflict=function(){return i["default"].fn[ut]=ko,l._jQueryInterface};var ft="ExpandableTable",rr="lte.expandableTable",rf="."+rr,rs=i["default"].fn[ft],us="expanded"+rf,fs="collapsed"+rf,uf='[data-widget="expandable-table"]',oi="aria-expanded",a=function(){function n(n,t){this._options=t;this._element=n}var t=n.prototype;return t.init=function(){i["default"](uf).each(function(n,t){var u=i["default"](t).attr(oi),r=i["default"](t).next().children().first().children();u==="true"?r.show():u==="false"&&(r.hide(),r.parent().parent().addClass("d-none"))})},t.toggleRow=function(){var n=this._element,r=500,u=n.attr(oi),t=n.next().children().first().children();t.stop();u==="true"?(t.slideUp(r,function(){n.next().addClass("d-none")}),n.attr(oi,"false"),n.trigger(i["default"].Event(fs))):u==="false"&&(n.next().removeClass("d-none"),t.slideDown(r),n.attr(oi,"true"),n.trigger(i["default"].Event(us)))},n._jQueryInterface=function(t){return this.each(function(){var r=i["default"](this).data(rr);r||(r=new n(i["default"](this)),i["default"](this).data(rr,r));typeof t=="string"&&t.match(/init|toggleRow/)&&r[t]()})},n}();i["default"](".expandable-table").ready(function(){a._jQueryInterface.call(i["default"](this),"init")});i["default"](document).on("click",uf,function(){a._jQueryInterface.call(i["default"](this),"toggleRow")});i["default"].fn[ft]=a._jQueryInterface;i["default"].fn[ft].Constructor=a;i["default"].fn[ft].noConflict=function(){return i["default"].fn[ft]=rs,a._jQueryInterface};var et="Fullscreen",ff="lte.fullscreen",es=i["default"].fn[et],ef='[data-widget="fullscreen"]',of=ef+" i",sf={minimizeIcon:"fa-compress-arrows-alt",maximizeIcon:"fa-expand-arrows-alt"},ot=function(){function n(n,t){this.element=n;this.options=i["default"].extend({},sf,t)}var t=n.prototype;return t.toggle=function(){document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement?this.windowed():this.fullscreen()},t.fullscreen=function(){document.documentElement.requestFullscreen?document.documentElement.requestFullscreen():document.documentElement.webkitRequestFullscreen?document.documentElement.webkitRequestFullscreen():document.documentElement.msRequestFullscreen&&document.documentElement.msRequestFullscreen();i["default"](of).removeClass(this.options.maximizeIcon).addClass(this.options.minimizeIcon)},t.windowed=function(){document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen();i["default"](of).removeClass(this.options.minimizeIcon).addClass(this.options.maximizeIcon)},n._jQueryInterface=function(t){var r=i["default"](this).data(ff),f,u;r||(r=i["default"](this).data());f=i["default"].extend({},sf,typeof t=="object"?t:r);u=new n(i["default"](this),f);i["default"](this).data(ff,typeof t=="object"?t:r);typeof t=="string"&&t.match(/toggle|fullscreen|windowed/)?u[t]():u.init()},n}();i["default"](document).on("click",ef,function(){ot._jQueryInterface.call(i["default"](this),"toggle")});i["default"].fn[et]=ot._jQueryInterface;i["default"].fn[et].Constructor=ot;i["default"].fn[et].noConflict=function(){return i["default"].fn[et]=es,ot._jQueryInterface};var st="IFrame",hf="lte.iframe",os=i["default"].fn[st],si='[data-widget="iframe"]',ss='[data-widget="iframe-close"]',hs='[data-widget="iframe-scrollleft"]',cs='[data-widget="iframe-scrollright"]',ur='[data-widget="iframe-fullscreen"]',ht=".content-wrapper",fr=ht+" iframe",ls=si+".iframe-mode .nav",ct=si+".iframe-mode .navbar-nav",cf=ct+" .nav-item",hi=si+".iframe-mode .tab-content",v=hi+" .tab-empty",lt=hi+" .tab-loading",er=".main-sidebar .nav-item > a.nav-link",or=".main-header .nav-item a.nav-link",sr=".main-header a.dropdown-item",lf="iframe-mode",ci="iframe-mode-fullscreen",as={onTabClick:function(n){return n},onTabChanged:function(n){return n},onTabCreated:function(n){return n},autoIframeMode:!0,autoItemActive:!0,autoShowNewTab:!0,loadingScreen:!0,useNavbarItems:!0,scrollOffset:40,scrollBehaviorSwap:!1,iconMaximize:"fa-expand",iconMinimize:"fa-compress"},at=function(){function t(n,t){this._config=t;this._element=n;this._init()}var n=t.prototype;return n.onTabClick=function(n){this._config.onTabClick(n)},n.onTabChanged=function(n){this._config.onTabChanged(n)},n.onTabCreated=function(n){this._config.onTabCreated(n)},n.createTab=function(n,t,r,u){var f=this,o="panel-"+r+"-"+Math.floor(Math.random()*1e3),e="tab-"+r+"-"+Math.floor(Math.random()*1e3),c='<li class="nav-item" role="presentation"><a class="nav-link" data-toggle="row" id="'+e+'" href="#'+o+'" role="tab" aria-controls="'+o+'" aria-selected="false">'+n+"<\/a><\/li>",h,s;i["default"](ct).append(c);h='<div class="tab-pane fade" id="'+o+'" role="tabpanel" aria-labelledby="'+e+'"><iframe src="'+t+'"><\/iframe><\/div>';i["default"](hi).append(h);u&&(this._config.loadingScreen?(s=i["default"](lt),s.fadeIn(),i["default"](o+" iframe").ready(function(){typeof f._config.loadingScreen=="number"?(f.switchTab("#"+e,f._config.loadingScreen),setTimeout(function(){s.fadeOut()},f._config.loadingScreen)):(f.switchTab("#"+e,f._config.loadingScreen),s.fadeOut())})):this.switchTab("#"+e));this.onTabCreated(i["default"]("#"+e))},n.openTabSidebar=function(n,t){var r,f,u;(t===void 0&&(t=this._config.autoShowNewTab),r=i["default"](n).clone(),r.attr("href")===undefined&&(r=i["default"](n).parent("a").clone()),r.find(".right").remove(),f=r.find("p").text(),f===""&&(f=r.text()),u=r.attr("href"),u!=="#"&&u!==""&&u!==undefined)&&this.createTab(f,u,u.replace(".html","").replace("./","").replaceAll("/","-"),t)},n.switchTab=function(n){var t=i["default"](n),r=t.attr("href");i["default"](v).hide();i["default"](ct+" .active").tab("dispose").removeClass("active");this._fixHeight();t.tab("show");t.parents("li").addClass("active");this.onTabChanged(t);this._config.autoItemActive&&this._setItemActive(i["default"](r+" iframe").attr("src"))},n.removeActiveTab=function(){var n=i["default"](cf+".active"),r=n.parent(),u=n.index(),t;n.remove();i["default"](".tab-pane.active").remove();i["default"](hi).children().length==i["default"](v+", "+lt).length?i["default"](v).show():(t=u-1,this.switchTab(r.children().eq(t).find("a")))},n.toggleFullscreen=function(){i["default"]("body").hasClass(ci)?(i["default"](ur+" i").removeClass(this._config.iconMinimize).addClass(this._config.iconMaximize),i["default"]("body").removeClass(ci),i["default"](v+", "+lt).height("auto"),i["default"](ht).height("auto"),i["default"](fr).height("auto")):(i["default"](ur+" i").removeClass(this._config.iconMaximize).addClass(this._config.iconMinimize),i["default"]("body").addClass(ci));i["default"](window).trigger("resize");this._fixHeight(!0)},n._init=function(){window.frameElement&&this._config.autoIframeMode?i["default"]("body").addClass(lf):i["default"](ht).hasClass(lf)&&(this._setupListeners(),this._fixHeight(!0))},n._navScroll=function(n){var t=i["default"](ct).scrollLeft();i["default"](ct).animate({scrollLeft:t+n},250,"linear")},n._setupListeners=function(){var n=this,r,t;i["default"](window).on("resize",function(){setTimeout(function(){n._fixHeight()},1)});i["default"](document).on("click",er,function(t){t.preventDefault();n.openTabSidebar(t.target)});if(this._config.useNavbarItems)i["default"](document).on("click",or+", "+sr,function(t){t.preventDefault();n.openTabSidebar(t.target)});i["default"](document).on("click",cf,function(t){t.preventDefault();n.onTabClick(t.target);n.switchTab(t.target)});i["default"](document).on("click",ss,function(t){t.preventDefault();n.removeActiveTab()});i["default"](document).on("click",ur,function(t){t.preventDefault();n.toggleFullscreen()});r=!1;t=null;i["default"](document).on("mousedown",hs,function(i){i.preventDefault();clearInterval(t);var u=n._config.scrollOffset;n._config.scrollBehaviorSwap||(u=-u);r=!0;n._navScroll(u);t=setInterval(function(){n._navScroll(u)},250)});i["default"](document).on("mousedown",cs,function(i){i.preventDefault();clearInterval(t);var u=n._config.scrollOffset;n._config.scrollBehaviorSwap&&(u=-u);r=!0;n._navScroll(u);t=setInterval(function(){n._navScroll(u)},250)});i["default"](document).on("mouseup",function(){r&&(r=!1,clearInterval(t),t=null)})},n._setItemActive=function(n){i["default"](er+", "+sr).removeClass("active");i["default"](or).parent().removeClass("active");var t=i["default"](or+'[href$="'+n+'"]'),r=i["default"](sr+'[href$="'+n+'"]'),u=i["default"](er+'[href$="'+n+'"]');t.each(function(n,t){i["default"](t).parent().addClass("active")});r.each(function(n,t){i["default"](t).addClass("active")});u.each(function(n,t){i["default"](t).addClass("active");i["default"](t).parents(".nav-treeview").prevAll(".nav-link").addClass("active")})},n._fixHeight=function(n){var t,r,u;n===void 0&&(n=!1);i["default"]("body").hasClass(ci)?(t=i["default"](window).height(),i["default"](v+", "+lt).height(t),i["default"](ht).height(t),i["default"](fr).height(t)):(r=parseFloat(i["default"](ht).css("min-height")),u=i["default"](ls).outerHeight(),n==!0?setTimeout(function(){i["default"](v+", "+lt).height(r-u)},50):i["default"](fr).height(r-u))},t._jQueryInterface=function(n){var r=i["default"](this).data(hf),s=i["default"].extend({},as,i["default"](this).data()),e;if(r||(r=new t(this,s),i["default"](this).data(hf,r)),typeof n=="string"&&n.match(/createTab|openTabSidebar|switchTab|removeActiveTab/)){for(var f=arguments.length,o=new Array(f>1?f-1:0),u=1;u<f;u++)o[u-1]=arguments[u];(e=r)[n].apply(e,o)}},t}();i["default"](window).on("load",function(){at._jQueryInterface.call(i["default"](si))});i["default"].fn[st]=at._jQueryInterface;i["default"].fn[st].Constructor=at;i["default"].fn[st].noConflict=function(){return i["default"].fn[st]=os,at._jQueryInterface};var vt="Layout",af="lte.layout",vs=i["default"].fn[vt],vf=".main-header",yf=".main-sidebar",y=".main-sidebar .sidebar",ys=".content-wrapper",ps=".control-sidebar-content",ws='[data-widget="control-sidebar"]',hr=".main-footer",bs='[data-widget="pushmenu"]',ks=".login-box",ds=".register-box",pf="sidebar-focused",gs="layout-fixed",nh="control-sidebar-slide-open",th="control-sidebar-open",ih="layout-top-nav",rh={scrollbarTheme:"os-theme-light",scrollbarAutoHide:"l",panelAutoHeight:!0,panelAutoHeightMode:"min-height",loginRegisterAutoHeight:!0},yt=function(){function t(n,t){this._config=t;this._element=n;this._init()}var n=t.prototype;return n.fixLayoutHeight=function(n){var e,o,u;n===void 0&&(n=null);e=i["default"]("body");o=0;(e.hasClass(nh)||e.hasClass(th)||n==="control_sidebar")&&(o=i["default"](ps).height());var t={window:i["default"](window).height(),header:i["default"](vf).length!==0?i["default"](vf).outerHeight():0,footer:i["default"](hr).length!==0?i["default"](hr).outerHeight():0,sidebar:i["default"](y).length!==0?i["default"](y).height():0,controlSidebar:o},f=this._max(t),r=this._config.panelAutoHeight;(r===!0&&(r=0),u=i["default"](ys),r!==!1&&(f===t.controlSidebar?e.hasClass(ih)?u.css(this._config.panelAutoHeightMode,f+r+t.header+t.footer):u.css(this._config.panelAutoHeightMode,f+r):f===t.window?u.css(this._config.panelAutoHeightMode,f+r-t.header-t.footer):u.css(this._config.panelAutoHeightMode,f+r-t.header),this._isFooterFixed()&&u.css(this._config.panelAutoHeightMode,parseFloat(u.css(this._config.panelAutoHeightMode))+t.footer)),e.hasClass(gs))&&(r!==!1&&u.css(this._config.panelAutoHeightMode,f+r-t.header-t.footer),typeof i["default"].fn.overlayScrollbars!="undefined"&&i["default"](y).overlayScrollbars({className:this._config.scrollbarTheme,sizeAutoCapable:!0,scrollbars:{autoHide:this._config.scrollbarAutoHide,clickScrolling:!0}}))},n.fixLoginRegisterHeight=function(){var n=i["default"]("body"),r=i["default"](ks+", "+ds),t;r.length===0?(n.css("height","auto"),i["default"]("html").css("height","auto")):(t=r.height(),n.css(this._config.panelAutoHeightMode)!==t&&n.css(this._config.panelAutoHeightMode,t))},n._init=function(){var n=this;this.fixLayoutHeight();this._config.loginRegisterAutoHeight===!0?this.fixLoginRegisterHeight():this._config.loginRegisterAutoHeight===parseInt(this._config.loginRegisterAutoHeight,10)&&setInterval(this.fixLoginRegisterHeight,this._config.loginRegisterAutoHeight);i["default"](y).on("collapsed.lte.treeview expanded.lte.treeview",function(){n.fixLayoutHeight()});i["default"](bs).on("collapsed.lte.pushmenu shown.lte.pushmenu",function(){n.fixLayoutHeight()});i["default"](ws).on("collapsed.lte.controlsidebar",function(){n.fixLayoutHeight()}).on("expanded.lte.controlsidebar",function(){n.fixLayoutHeight("control_sidebar")});i["default"](window).resize(function(){n.fixLayoutHeight()});i["default"](document).ready(function(){n.fixLayoutHeight()});setTimeout(function(){i["default"]("body.hold-transition").removeClass("hold-transition")},50)},n._max=function(n){var t=0;return Object.keys(n).forEach(function(i){n[i]>t&&(t=n[i])}),t},n._isFooterFixed=function(){return i["default"](hr).css("position")==="fixed"},t._jQueryInterface=function(n){return n===void 0&&(n=""),this.each(function(){var r=i["default"](this).data(af),u=i["default"].extend({},rh,i["default"](this).data());r||(r=new t(i["default"](this),u),i["default"](this).data(af,r));n==="init"||n===""?r._init():(n==="fixLayoutHeight"||n==="fixLoginRegisterHeight")&&r[n]()})},t}();i["default"](window).on("load",function(){yt._jQueryInterface.call(i["default"]("body"))});i["default"](y+" a").on("focusin",function(){i["default"](yf).addClass(pf)});i["default"](y+" a").on("focusout",function(){i["default"](yf).removeClass(pf)});i["default"].fn[vt]=yt._jQueryInterface;i["default"].fn[vt].Constructor=yt;i["default"].fn[vt].noConflict=function(){return i["default"].fn[vt]=vs,yt._jQueryInterface};var pt="PushMenu",cr="lte.pushmenu",wt="."+cr,uh=i["default"].fn[pt],fh="collapsed"+wt,eh="shown"+wt,lr='[data-widget="pushmenu"]',li="body",oh="#sidebar-overlay",sh=".wrapper",u="sidebar-collapse",p="sidebar-open",wf="sidebar-is-opening",ar="sidebar-closed",bf={autoCollapseSize:992,enableRemember:!1,noTransitionAfterReload:!0},w=function(){function t(n,t){this._element=n;this._options=i["default"].extend({},bf,t);i["default"](oh).length===0&&this._addOverlay();this._init()}var n=t.prototype;return n.expand=function(){var n=i["default"](li);this._options.autoCollapseSize&&i["default"](window).width()<=this._options.autoCollapseSize&&n.addClass(p);n.addClass(wf).removeClass(u+" "+ar).delay(50).queue(function(){n.removeClass(wf);i["default"](this).dequeue()});this._options.enableRemember&&localStorage.setItem("remember"+wt,p);i["default"](this._element).trigger(i["default"].Event(eh))},n.collapse=function(){var n=i["default"](li);this._options.autoCollapseSize&&i["default"](window).width()<=this._options.autoCollapseSize&&n.removeClass(p).addClass(ar);n.addClass(u);this._options.enableRemember&&localStorage.setItem("remember"+wt,u);i["default"](this._element).trigger(i["default"].Event(fh))},n.toggle=function(){i["default"](li).hasClass(u)?this.expand():this.collapse()},n.autoCollapse=function(n){if(n===void 0&&(n=!1),this._options.autoCollapseSize){var t=i["default"](li);i["default"](window).width()<=this._options.autoCollapseSize?t.hasClass(p)||this.collapse():n===!0&&(t.hasClass(p)?t.removeClass(p):t.hasClass(ar)&&this.expand())}},n.remember=function(){if(this._options.enableRemember){var n=i["default"]("body"),t=localStorage.getItem("remember"+wt);t===u?this._options.noTransitionAfterReload?n.addClass("hold-transition").addClass(u).delay(50).queue(function(){i["default"](this).removeClass("hold-transition");i["default"](this).dequeue()}):n.addClass(u):this._options.noTransitionAfterReload?n.addClass("hold-transition").removeClass(u).delay(50).queue(function(){i["default"](this).removeClass("hold-transition");i["default"](this).dequeue()}):n.removeClass(u)}},n._init=function(){var n=this;this.remember();this.autoCollapse();i["default"](window).resize(function(){n.autoCollapse(!0)})},n._addOverlay=function(){var t=this,n=i["default"]("<div />",{id:"sidebar-overlay"});n.on("click",function(){t.collapse()});i["default"](sh).append(n)},t._jQueryInterface=function(n){return this.each(function(){var r=i["default"](this).data(cr),u=i["default"].extend({},bf,i["default"](this).data());r||(r=new t(this,u),i["default"](this).data(cr,r));typeof n=="string"&&n.match(/collapse|expand|toggle/)&&r[n]()})},t}();i["default"](document).on("click",lr,function(n){n.preventDefault();var t=n.currentTarget;i["default"](t).data("widget")!=="pushmenu"&&(t=i["default"](t).closest(lr));w._jQueryInterface.call(i["default"](t),"toggle")});i["default"](window).on("load",function(){w._jQueryInterface.call(i["default"](lr))});i["default"].fn[pt]=w._jQueryInterface;i["default"].fn[pt].Constructor=w;i["default"].fn[pt].noConflict=function(){return i["default"].fn[pt]=uh,w._jQueryInterface};var bt="SidebarSearch",kf="lte.sidebar-search",hh=i["default"].fn[bt],vr="sidebar-search-open",df="fa-search",gf="fa-times",ch="nav-header",ne="sidebar-search-results",yr="list-group",r='[data-widget="sidebar-search"]',lh=".main-sidebar .nav-sidebar",ah=".nav-link",vh=".nav-treeview",pr=r+" .form-control",te=r+" .btn",ie=te+" i",yh="."+yr,ai="."+ne,e=ai+" ."+yr,re={arrowSign:"->",minLength:3,maxResults:7,highlightName:!0,highlightPath:!1,highlightClass:"text-light",notFoundText:"No element found!"},ue=[],o=function(){function u(n,t){this.element=n;this.options=i["default"].extend({},re,t);this.items=[]}var n=u.prototype;return n.init=function(){var n=this;i["default"](r).length!=0&&(i["default"](r).next(ai).length==0&&i["default"](r).after(i["default"]("<div />",{"class":ne})),i["default"](ai).children(yh).length==0&&i["default"](ai).append(i["default"]("<div />",{"class":yr})),this._addNotFound(),i["default"](lh).children().each(function(t,i){n._parseItem(i)}))},n.search=function(){var u=this,t=i["default"](pr).val().toLowerCase(),r,n;if(t.length<this.options.minLength){i["default"](e).empty();this._addNotFound();this.close();return}r=ue.filter(function(n){return n.name.toLowerCase().includes(t)});n=i["default"](r.slice(0,this.options.maxResults));i["default"](e).empty();n.length===0?this._addNotFound():n.each(function(n,t){i["default"](e).append(u._renderItem(t.name,t.link,t.path))});this.open()},n.open=function(){i["default"](r).parent().addClass(vr);i["default"](ie).removeClass(df).addClass(gf)},n.close=function(){i["default"](r).parent().removeClass(vr);i["default"](ie).removeClass(gf).addClass(df)},n.toggle=function(){i["default"](r).parent().hasClass(vr)?this.close():this.open()},n._parseItem=function(n,t){var o=this,e;if(t===void 0&&(t=[]),!i["default"](n).hasClass(ch)){var r={},u=i["default"](n).clone().find("> "+ah),f=i["default"](n).clone().find("> "+vh),s=u.attr("href"),h=u.find("p").children().remove().end().text();r.name=this._trimText(h);r.link=s;r.path=t;f.length===0?ue.push(r):(e=r.path.concat([r.name]),f.children().each(function(n,t){o._parseItem(t,e)}))}},n._trimText=function(n){return t.trim(n.replace(/(\r\n|\n|\r)/gm," "))},n._renderItem=function(n,t,r){var f=this,e,u;return r=r.join(" "+this.options.arrowSign+" "),(this.options.highlightName||this.options.highlightPath)&&(e=i["default"](pr).val().toLowerCase(),u=new RegExp(e,"gi"),this.options.highlightName&&(n=n.replace(u,function(n){return'<b class="'+f.options.highlightClass+'">'+n+"<\/b>"})),this.options.highlightPath&&(r=r.replace(u,function(n){return'<b class="'+f.options.highlightClass+'">'+n+"<\/b>"}))),'<a href="'+t+'" class="list-group-item">\n        <div class="search-title">\n          '+n+'\n        <\/div>\n        <div class="search-path">\n          '+r+"\n        <\/div>\n      <\/a>"},n._addNotFound=function(){i["default"](e).append(this._renderItem(this.options.notFoundText,"#",[]))},u._jQueryInterface=function(n){var t=i["default"](this).data(kf),f,r;t||(t=i["default"](this).data());f=i["default"].extend({},re,typeof n=="object"?n:t);r=new u(i["default"](this),f);i["default"](this).data(kf,typeof n=="object"?n:t);typeof n=="string"&&n.match(/init|toggle|close|open|search/)?r[n]():r.init()},u}();i["default"](document).on("click",te,function(n){n.preventDefault();o._jQueryInterface.call(i["default"](r),"toggle")});i["default"](document).on("keyup",pr,function(n){if(n.keyCode==38){n.preventDefault();i["default"](e).children().last().focus();return}if(n.keyCode==40){n.preventDefault();i["default"](e).children().first().focus();return}var t=0;clearTimeout(t);t=setTimeout(function(){o._jQueryInterface.call(i["default"](r),"search")},100)});i["default"](document).on("keydown",e,function(n){var t=i["default"](":focus");n.keyCode==38&&(n.preventDefault(),t.is(":first-child")?t.siblings().last().focus():t.prev().focus());n.keyCode==40&&(n.preventDefault(),t.is(":last-child")?t.siblings().first().focus():t.next().focus())});i["default"](window).on("load",function(){o._jQueryInterface.call(i["default"](r),"init")});i["default"].fn[bt]=o._jQueryInterface;i["default"].fn[bt].Constructor=o;i["default"].fn[bt].noConflict=function(){return i["default"].fn[bt]=hh,o._jQueryInterface};var kt="Toasts",wr=".lte.toasts",ph=i["default"].fn[kt],wh="init"+wr,bh="created"+wr,kh="removed"+wr,dh="#toastsContainerTopRight",gh="#toastsContainerTopLeft",nc="#toastsContainerBottomRight",tc="#toastsContainerBottomLeft",ic="toasts-top-right",rc="toasts-top-left",uc="toasts-bottom-right",fc="toasts-bottom-left",br="topRight",fe="topLeft",ee="bottomRight",oe="bottomLeft",ec={position:br,fixed:!0,autohide:!1,autoremove:!0,delay:1e3,fade:!0,icon:null,image:null,imageAlt:null,imageHeight:"25px",title:null,subtitle:null,close:!0,body:null,"class":null},vi=function(){function n(n,t){this._config=t;this._prepareContainer();i["default"]("body").trigger(i["default"].Event(wh))}var t=n.prototype;return t.create=function(){var n=i["default"]('<div class="toast" role="alert" aria-live="assertive" aria-atomic="true"/>'),t,r,u,f;if(n.data("autohide",this._config.autohide),n.data("animation",this._config.fade),this._config.class&&n.addClass(this._config.class),this._config.delay&&this._config.delay!=500&&n.data("delay",this._config.delay),t=i["default"]('<div class="toast-header">'),this._config.image!=null&&(r=i["default"]("<img />").addClass("rounded mr-2").attr("src",this._config.image).attr("alt",this._config.imageAlt),this._config.imageHeight!=null&&r.height(this._config.imageHeight).width("auto"),t.append(r)),this._config.icon!=null&&t.append(i["default"]("<i />").addClass("mr-2").addClass(this._config.icon)),this._config.title!=null&&t.append(i["default"]("<strong />").addClass("mr-auto").html(this._config.title)),this._config.subtitle!=null&&t.append(i["default"]("<small />").html(this._config.subtitle)),this._config.close==!0&&(u=i["default"]('<button data-dismiss="toast" />').attr("type","button").addClass("ml-2 mb-1 close").attr("aria-label","Close").append('<span aria-hidden="true">&times;<\/span>'),this._config.title==null&&u.toggleClass("ml-2 ml-auto"),t.append(u)),n.append(t),this._config.body!=null&&n.append(i["default"]('<div class="toast-body" />').html(this._config.body)),i["default"](this._getContainerId()).prepend(n),f=i["default"]("body"),f.trigger(i["default"].Event(bh)),n.toast("show"),this._config.autoremove)n.on("hidden.bs.toast",function(){i["default"](this).delay(200).remove();f.trigger(i["default"].Event(kh))})},t._getContainerId=function(){return this._config.position==br?dh:this._config.position==fe?gh:this._config.position==ee?nc:this._config.position==oe?tc:void 0},t._prepareContainer=function(){if(i["default"](this._getContainerId()).length===0){var n=i["default"]("<div />").attr("id",this._getContainerId().replace("#",""));this._config.position==br?n.addClass(ic):this._config.position==fe?n.addClass(rc):this._config.position==ee?n.addClass(uc):this._config.position==oe&&n.addClass(fc);i["default"]("body").append(n)}this._config.fixed?i["default"](this._getContainerId()).addClass("fixed"):i["default"](this._getContainerId()).removeClass("fixed")},n._jQueryInterface=function(t,r){return this.each(function(){var u=i["default"].extend({},ec,r),f=new n(i["default"](this),u);t==="create"&&f[t]()})},n}();i["default"].fn[kt]=vi._jQueryInterface;i["default"].fn[kt].Constructor=vi;i["default"].fn[kt].noConflict=function(){return i["default"].fn[kt]=ph,vi._jQueryInterface};var dt="TodoList",se="lte.todolist",oc=i["default"].fn[dt],sc='[data-widget="todo-list"]',he="done",hc={onCheck:function(n){return n},onUnCheck:function(n){return n}},gt=function(){function n(n,t){this._config=t;this._element=n;this._init()}var t=n.prototype;return t.toggle=function(n){if(n.parents("li").toggleClass(he),!i["default"](n).prop("checked")){this.unCheck(i["default"](n));return}this.check(n)},t.check=function(n){this._config.onCheck.call(n)},t.unCheck=function(n){this._config.onUnCheck.call(n)},t._init=function(){var t=this,n=this._element;n.find("input:checkbox:checked").parents("li").toggleClass(he);n.on("change","input:checkbox",function(n){t.toggle(i["default"](n.target))})},n._jQueryInterface=function(t){return this.each(function(){var r=i["default"](this).data(se),u,f;r||(r=i["default"](this).data());u=i["default"].extend({},hc,typeof t=="object"?t:r);f=new n(i["default"](this),u);i["default"](this).data(se,typeof t=="object"?t:r);t==="init"&&f[t]()})},n}();i["default"](window).on("load",function(){gt._jQueryInterface.call(i["default"](sc))});i["default"].fn[dt]=gt._jQueryInterface;i["default"].fn[dt].Constructor=gt;i["default"].fn[dt].noConflict=function(){return i["default"].fn[dt]=oc,gt._jQueryInterface};var ni="Treeview",kr="lte.treeview",dr="."+kr,cc=i["default"].fn[ni],lc="expanded"+dr,ac="collapsed"+dr,vc="load"+dr,gr=".nav-item",s=".nav-treeview",yi=".menu-open",ce='[data-widget="treeview"]',pi="menu-open",le="menu-is-opening",yc="sidebar-collapse",pc={trigger:ce+" .nav-link",animationSpeed:300,accordion:!0,expandSidebar:!1,sidebarButtonSelector:'[data-widget="pushmenu"]'},ti=function(){function t(n,t){this._config=t;this._element=n}var n=t.prototype;return n.init=function(){i["default"](""+gr+yi+" "+s).css("display","block");this._setupListeners()},n.expand=function(n,t){var f=this,e=i["default"].Event(lc),r,u;this._config.accordion&&(r=t.siblings(yi).first(),u=r.find(s).first(),this.collapse(u,r));t.addClass(le);n.stop().slideDown(this._config.animationSpeed,function(){t.addClass(pi);i["default"](f._element).trigger(e)});this._config.expandSidebar&&this._expandSidebar()},n.collapse=function(n,t){var r=this,u=i["default"].Event(ac);t.removeClass(le+" "+pi);n.stop().slideUp(this._config.animationSpeed,function(){i["default"](r._element).trigger(u);n.find(yi+" > "+s).slideUp();n.find(yi).removeClass(pi)})},n.toggle=function(n){var f=i["default"](n.currentTarget),u=f.parent(),t=u.find("> "+s),r,e;(t.is(s)||(u.is(gr)||(t=u.parent().find("> "+s)),t.is(s)))&&(n.preventDefault(),r=f.parents(gr).first(),e=r.hasClass(pi),e?this.collapse(i["default"](t),r):this.expand(i["default"](t),r))},n._setupListeners=function(){var n=this,t=this._element.attr("id")!==undefined?"#"+this._element.attr("id"):"";i["default"](document).on("click",""+t+this._config.trigger,function(t){n.toggle(t)})},n._expandSidebar=function(){i["default"]("body").hasClass(yc)&&i["default"](this._config.sidebarButtonSelector).PushMenu("expand")},t._jQueryInterface=function(n){return this.each(function(){var r=i["default"](this).data(kr),u=i["default"].extend({},pc,i["default"](this).data());r||(r=new t(i["default"](this),u),i["default"](this).data(kr,r));n==="init"&&r[n]()})},t}();i["default"](window).on(vc,function(){i["default"](ce).each(function(){ti._jQueryInterface.call(i["default"](this),"init")})});i["default"].fn[ni]=ti._jQueryInterface;i["default"].fn[ni].Constructor=ti;i["default"].fn[ni].noConflict=function(){return i["default"].fn[ni]=cc,ti._jQueryInterface};n.CardRefresh=h;n.CardWidget=f;n.ControlSidebar=tt;n.DirectChat=rt;n.Dropdown=l;n.ExpandableTable=a;n.Fullscreen=ot;n.IFrame=at;n.Layout=yt;n.PushMenu=w;n.SidebarSearch=o;n.Toasts=vi;n.TodoList=gt;n.Treeview=ti;Object.defineProperty(n,"__esModule",{value:!0})});